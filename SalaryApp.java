...
public class SalaryApp {
    ...
    public static void main(String[] args)
    {
        ...
        //System.out.println("this program will organize your SALARY, just enter your salary, 0 will end the App");

//        while(start == -1)
//        {
            //double salary = in.nextDouble();  // read the salary
            
//            if(salary > 1500 && salary < 60000)
//            {
//                System.out.println("your salary is " + salary + " EGP and the best organize for it is");
...
//            }
//            else if(salary < -1)  // i have an issue here if i pressed -100 and then 500 to calculate the 500 the app continue first like it will print theanks for using the app and then will ask me again about the salary again to calculate it 500 so i entered 500 twice to be calculated
//            {
        ...
        public static void calculateSalary() {
            ...
            while(true) {
                if(salary > 1500 && salary < 60000) {
                    ...
                    if(salary == 1)
                        openScreen();
                    else if(salary == 0)  // i have a bug here when i press 0 at the first time it's ok but the second time no
                        break;
                }
            }
        }    
